...
class MyHomePage extends StatefulWidget {
  String dVal;
  MyHomePage({Key? key, required this.dVal}) : super(key: key);
      ...
      body: Consumer<WeatherProvider>(
        builder: (context, weatherPro, child) {
          ...
          return WillPopScope(
            ...
            child: Container(
              color: Colors.white,
              child: weatherPro.weatherModel.current.condition.text.isEmpty
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                Text(
                                  weatherPro.weatherModel.current.tempC
                                          .toStringAsFixed(1) +
                                      ' \u00B0' +
                                      'C',
                                  style: TextStyle(
                                ...
                                ListTile(
                                  ...
                                  title: Text('Humidity',
                                      style: TextStyle(
                                          ...
                                          fontSize: 20)),
                                  trailing: Text(
                                      weatherPro.weatherModel.current.humidity
                                              .toString() +
                                          ' %',
                                      style: TextStyle(
                                          color: AllColor.fontColor,
                                ...
                                ListTile(
                                  ...
                                  title: Text('Wind Speed',
                                      style: TextStyle(
                                          ...
                                          fontSize: 20)),
                                  trailing: Text(
                                      weatherPro.weatherModel.current.windKph
                                              .toString() +
                                          ' km/h',
                                      style: TextStyle(
                                          color: AllColor.fontColor,
